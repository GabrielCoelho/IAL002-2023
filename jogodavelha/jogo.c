...
int main(int argc, char *argv[]) {
  ...
  //     if (linha > 3 || linha <= 0) {
  //       printf(
  //           "Informe a linha dentro do padrão disposto, isto é, 1 - 2 ou
  //           3!\n");
  //       linha = 0;
  //     }
  //   }
  ...
  //     scanf("%d", &coluna);
  //     if (coluna > 3 || linha <= 0) {
  //       printf("Informe a coluna dentro do padrão disposto, isto é, 1 - 2 ou
  //       "
  //              "3!\n");
  //       coluna = 0;
  //     }
  ...
  //       //}
  //       for (int i = 0; i < 3; i++) {
  //         if ((velha[i][0] != ' ') && (velha[i][0] == velha[i][1]) &&
  //             ((velha[i][1] == velha[i][2]) && velha[i][2] != ' ')) {
  //           jogo = false;
  //           printf("o Jogador %c ganhou a partida (primeiro if)\n", jogador);
  //           return 0;
  //         } else if ((velha[0][i] == velha[1][i] &&
  //                     velha[0][i] == velha[2][i]) &&
  //                    velha[1][i] == velha[2][i]) {
  //           jogo = false;
  //           printf("o Jogador %c ganhou a partida (segundo if)\n", jogador);
  //           return 0;
  //         } else if (velha[0][0] == velha[1][1] && velha[0][0] ==
  //         velha[2][2]) {
  //           jogo = false;
  //           printf("o Jogador %c ganhou a partida (terceiro if)\n", jogador);
  //           return 0;
  //         } else if (velha[0][2] == velha[1][1] && velha[0][2] ==
  //         velha[2][0]) {
  //           jogo = false;
